...
{
    public class OneLoginAuthenticationServiceTests
    {
        private readonly Mock<ILogger<OneLoginAuthenticationService>> _loggerMock;
        ...
        private readonly OneLoginAuthenticationService _service;

        public OneLoginAuthenticationServiceTests()
        {
            _loggerMock = new Mock<ILogger<OneLoginAuthenticationService>>();
            ...
            _service = new OneLoginAuthenticationService(
                _loggerMock.Object,
                _authEventHandler,
                _optionsMock.Object
            );
        ...
        public async Task RedirectToIdentityProviderForSignOutAsync_SetsIdTokenHintAndPostLogoutRedirectUri()
        {
            ...
            using (new AssertionScope())
            {
                ...
                postLogoutRedirectUri.Should().Contain(_authProviderOptions.OneLogin.SignOutCallbackPath);
            }
        }
    }
}