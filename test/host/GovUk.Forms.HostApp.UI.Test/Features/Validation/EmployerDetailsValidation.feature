...
So that I can fix errors immediately and avoid delayed rejection
 ...
 Background:
      Given I am on the upload page as a "InssTestFourteen" user

@regression @validation @rp14a  @cleanCosmosDb
...
Scenario: RP14A Display multiple validation categories together
    ...
    And I should see the following multiple validation errors
        ...
        | Case             | Case reference              | 1 case reference does not match the validated case reference {validCaseReference} |                                  |
...
@regression @validation @rp14a @api-upload @cleanCosmosDb
