...
public class RP14ApiValidatorTests
{
    ...
    [InlineData("CN12345678000")]
    public void InvalidCaseRef_TestValidate_ReturnsInvalidResult(string? invalidCaseRef)
    {
        RP14 model = new()
        {
            Header = new RP14Header { CaseReference = invalidCaseRef },
    ...
    public void InvalidBusinessName_TestValidate_ReturnsInvalidResult(string? invalidBusinessName)
    {
        RP14 model = new()
        {
            Header = new RP14Header { CaseReference = "CN12345678" },
