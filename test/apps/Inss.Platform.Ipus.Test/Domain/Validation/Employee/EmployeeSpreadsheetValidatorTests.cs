...
using Inss.Platform.Ipus.Domain.Validation.Employee;
using Xunit;

namespace Inss.Platform.Ipus.Test.Domain.Validation.Employee;
...
public class EmployeeSpreadsheetValidatorTests
{
    ...
    public void InvalidAverageHoursWorked_ValidateAsync_ReturnsError()
    {
        ...
        ValidatorContext context = _validator.Validate(_model.Employee[0].Header.CaseReference);
