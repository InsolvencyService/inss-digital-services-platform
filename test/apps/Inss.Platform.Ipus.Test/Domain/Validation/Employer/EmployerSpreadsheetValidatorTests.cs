...
using Inss.Platform.Ipus.Domain.Validation;
using Inss.Platform.Ipus.Domain.Validation.Employer;
using Xunit;

namespace Inss.Platform.Ipus.Test.Domain.Validation.Employer;
...
public class EmployerSpreadsheetValidatorTests
{
    ...
    public void MismatchCaseRef_ValidateAsync_ReturnsError()
    {
        ...
        ValidatorContext context = _validator.Validate("CN12345678");
    ...
    public void MissingBusinessName_ValidateAsync_ReturnsError(string? businessName)
    {
        ...
        ValidatorContext context = _validator.Validate(_model.Header.CaseReference);
    ...
    {
        _model.Directors.Director1 = null;
        _model.Directors.Director2 = null;
    ...
    public void ValidModelNoAnswerAssociatedCompanies_ValidateAsync_ReturnsNoErrors()
    {
        ...
        _model.AssociatedCompanies.AssociatedCompany1 = null;
        _model.AssociatedCompanies.AssociatedCompany2 = null;
    ...
    public void ValidModelNoAnswerEmployeesClaimingContinuity_ValidateAsync_ReturnsNoErrors()
    {
        ...
        _model.Employees.EmployeesClaimingContinuity.EmployerAddrLine1 = null;
