...
public class YourEmployeesFlowchartTests
{
    [Fact]
    public void RegisteredFormWithEmployeeDetailsSection_Construct_RegistersFlowchartForSection()
    {
        ...
        YourEmployeesFlowchart flowchart = new();
