...
public static partial class LoggerExtensions
{
    ...
    [LoggerMessage(EventId = 504, Level = LogLevel.Information, Message = "Submitting message {Id} and {Reference} of type {Type} to Dynamics.")]
    public static partial void SubmittingDynamicsMessage(this ILogger logger, string id, string reference, string type);
