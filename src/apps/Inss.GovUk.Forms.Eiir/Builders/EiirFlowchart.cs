...
using Inss.GovUk.Forms.Eiir.Application.DataFlow;
using Microsoft.Extensions.DependencyInjection;

namespace Inss.GovUk.Forms.Eiir.Builders;

public sealed class EiirFlowchart : DefineFlowchartBuilder
{
    ...
    public override void Construct(IServiceCollection services)
    {
        ...
        SectionModel section = form.Sections["Individual Insolvency Register"];
