...
public sealed class CaseReferenceFlowNodeExecutor : IFlowNodeExecutor
{
    ...
    public ValueTask<NodeId?> ExecuteAsync(FlowNodeContext context)
    {
        ...
        string savedCaseReference = savedCheckCaseReference.CaseReference.Value;
        ...
        if (savedCaseReference != caseReference && savedCheckCaseReference.ReturnUrl is not null)
        {
