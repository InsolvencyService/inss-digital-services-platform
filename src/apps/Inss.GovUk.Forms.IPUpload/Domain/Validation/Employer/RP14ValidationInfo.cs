...
internal sealed class RP14ValidationInfo : ValidationInfo
{
    ...
    internal static readonly RP14ValidationInfo MissingContinuityEmployerName = new("Employment continuity", "Employer name", "[COUNT] missing a employer name");
    ...
    // Transfers to
    internal static readonly RP14ValidationInfo MissingTransferToName = new("Transfers", "Transfer to name", "[COUNT] missing a transfer to name");
    ...
    internal RP14ValidationInfo(string category, string property, string error, string? hint = null) : base(category, property, error, hint)
    {
    }
}