    ...
    public void Configure(IWebHostBuilder builder)
    {
        builder.ConfigureServices((context, services) =>
        {
            ...
            FormBuilder
                ...
                .WithMetaData(new ButtonPageMetaData("Continue"))
                .WithExecutor<YourAgePageExecutor>()
                .NextNode()
                ...
                .WithMetaData(new ButtonPageMetaData("Continue"))
                .WithExecutor<YourSalaryPageExecutor>()
                .NextNode()
                ...
                .WithMetaData(new ButtonPageMetaData("Continue"))
                .WithValidator<BankAccountPageValidator>()
                .NextNode()
                ...
                .WithMetaData(new ButtonPageMetaData("Continue"))
                .WithExecutor<OwnHomePageExecutor>()
                .NextNode()
                ...
                .WithLoader<AboutYouSummaryPageLoader>()
                .WithExecutor<SectionSummaryPageExecutor>()
                .NodesDone()
                .RegisterSection()
                .FinalizeForm();
