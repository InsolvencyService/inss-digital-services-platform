...
/// <summary>
/// Repository implementation for managing <see cref="BankDetails"/> entities.
/// </summary>
public class BankDetailsRepository : RepositoryBase<BankDetails>, IBankDetailsRepository
{
    /// <summary>
    /// Initializes a new instance of the <see cref="BankDetailsRepository"/> class.
    /// </summary>
    /// <param name="logger">The logger instance for logging repository operations.</param>
    /// <param name="context">The database context for user management.</param>
    public BankDetailsRepository(ILogger<BankDetailsRepository> logger, CanonicalDbContext context) 
        : base(logger, context) { }
}
