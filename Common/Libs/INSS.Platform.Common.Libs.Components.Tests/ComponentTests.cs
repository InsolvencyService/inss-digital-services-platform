...
//{    
//    [Fact]
//    public void Button_AcceptsParameters_RendersCorrectly()
//    {
//        // Arrange
...
//    [Fact]
//    public void TextInput_AcceptsParameters_RendersCorrectly()
//    {
//        // Arrange
//        var id = "test-id";
//        var text = "Event Name";
//        var name = "eventName";
//        var placeholder = "Enter event name";
//        var type = "text";
...
//                    </label>
//                </h1>
//                <input class=""govuk-input"" id=""{id}"" name=""{name}"" placeholder=""{placeholder}"" type=""{type}"" value="""" />
//            </div>
//        ");
//    }
